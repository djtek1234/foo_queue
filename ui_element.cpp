...
public:
	...
	static GUID g_get_guid() {
		...
		static const GUID guid_myelem = { 0x1591283, 0xb229, 0x49e4, { 0xbe, 0xbc, 0x10, 0xc5, 0x5e, 0x79, 0xc5, 0xae } };
		return guid_myelem;
	}
	static GUID g_get_subclass() {return ui_element_subclass_utility;}
	static void g_get_name(pfc::string_base & out) {out = "FooQueue";}
	static ui_element_config::ptr g_get_default_configuration() {return ui_element_config::g_create_empty(g_get_guid());}
	static const char * g_get_description() {return "This has not been implemented yet.";}
...
void CMyElemWindow::OnPaint(CDCHandle) {
	...
	WIN32_OP_D(dc.DrawText(_T("This has not been implemented yet!"), -1, &rc, format) > 0);
}
